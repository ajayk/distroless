...
container_bundle(
    ...
    images = {
        ...
        "gcr.io/{PROJECT_ID}/java:12": "//java:java12",
        "gcr.io/{PROJECT_ID}/java:12-debug": "//java:java12_debug",
        ...
        "gcr.io/{PROJECT_ID}/java/jetty:java12": "//java/jetty:jetty_java12",
        "gcr.io/{PROJECT_ID}/java/jetty:java12-debug": "//java/jetty:jetty_java12_debug",
